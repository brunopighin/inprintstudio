          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3">
                <a href="https://www.instagram.com/inprint.studio_/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-gradient-to-tr from-yellow-400 via-pink-600 to-purple-600 flex items-center justify-center text-white hover:opacity-90 transition-opacity">
                  <Instagram size={16} />
                </a>
              </div>
            </div>
